...
{% include embed-audio.html src="/assets/audio/samples/oil-en-ds-sample.wav" %}

### [Japanese CVVC 2.0](/singers/oil/ja-cvvc-2.x/){: .btn .btn--primary}
{% include embed-audio.html src="/assets/audio/samples/oil-ja-cvvc-2.0-sample.wav" %}

### [Japanese CVVC 1.0](/singers/oil/ja-cvvc-1.x/){: .btn .btn}
{% include embed-audio.html src="/assets/audio/samples/oil-ja-cvvc-1.0-sample.wav" %}

## Downloads

[DiffSinger](/placeholder/){: .btn .btn--warning} 
# Voicebank Info **(WIP)**:

## DiffSinger **(WIP)**

Demo Song: It Just Keeps Going (Kaguo): English Translation
...
Demo Song: It Just Keeps Going (Kaguo) **(WIP)**
