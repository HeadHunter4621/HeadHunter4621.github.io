---
title: "En'ne Jeho [鉛音ジェホ] - Japanese CVVX V1"
permalink: /singers/en'ne-jeho/ja-cvvx-v1/
---
...
## Downloads
[JA CVVX v110](https://bowlroll.net/file/355509){: .btn .btn--primary}
...
- Extra Features:
    - Breaths structured like CV's and VC's ([a IN], etc) (Only for vowels)
    - Standalone breaths: [IN1]-[IN9]
    - Stops: VCV-formatted v'V for stop (ex: [a'い])
    - American-English R ([wra]-[wro]) and L ([la]-[lo]) (with CV and VCs ([a l], [a r]))
