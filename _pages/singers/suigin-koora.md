...
- Songs Used in Data:
    - English:
      ...
      - Suigin Koora's English UTAU Voicebank Data
    - Japanese
      ...
      - Charles (Balloon)
      - Darling (Suda Keina)
      - Hadal Abyss Zone (Inabakumori)
      - Kyoufuu All Back (Yukopi)
      - Phony (Ueda Tsubasa)
      - Senbonzakura (Kurousa-P)
      - Young Girl A (Shiina Mota)
      - Suigin Koora's Japanese UTAU Voicebank Data
...
- Recorded Pitch: ~C3 (Optimum Pitch Range: F2~F4)

## FR CVVC **(WIP)** 

### Info:

- Reclist: [UTAUFrance Petit Mot](https://utaufrance.com/reclist-francaise-petit-mot/)
- Recorded Pitch: C3 @ 120 BPM (Optimum Pitch Range: F2~F5)
...
KougaP reserves the right to request takedown of published content at any time, and users are expected to comply.
...
Existing artwork of the voicebank character cannot be used without prior permission from the individual artists.
...
The contents of this voicebank can only be used in permitted singing synthesizers. You cannot use it in any other way, such as for music production or video production.
