...
It's a really fun project. The phonetics are really simple (with a few exceptions), since it's CV with the same consonants as toki pona (other than w being replaced with v) and an ending consonant s
