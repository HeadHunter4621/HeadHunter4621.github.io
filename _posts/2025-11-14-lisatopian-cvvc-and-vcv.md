...
It's a really fun project. The phonetics are really simple (with a few exceptions), since it's CV with the same consonants as toki pona (other than w being replaced with v) and an ending consonants. I originally made it CVVC, but after placing the phonemes manually (very time-consuming!), I think I am going to try to make it VCV instead, with VsCV phonemes when there is the s coda (and a VC [V s] phoneme for the end of words)
